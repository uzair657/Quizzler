...
class Questions_home {
  int _questionCount = 0;
  List<Questions> _myQuestionsData = [
  ...
  void nextQuestion() {
    if (_questionCount < _myQuestionsData.length - 1) {
      _questionCount++;
    }
  }
  ...
  String getQuestionsText() {
    return _myQuestionsData[_questionCount].questionText;
  }

  bool getQuestionsAnswer() {
    return _myQuestionsData[_questionCount].answerAnswer;
  }
}
